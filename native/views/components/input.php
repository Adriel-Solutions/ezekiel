...
<?php if ( $params['type'] !== 'hidden' ): ?>
    <div
        ...
        <?php if (isset($params['attributes']) && isset($params['attributes']['x-show'])): ?>
            x-show="<?= $params['attributes']['x-show'] ?>"
        <?php endif; ?>
...
<?php endif; ?>
        ...
        <?php if ( $params['type'] === 'password' && isset($params['hint']) && $params['hint'] === true ): ?>
            <button 
                type="button" 
                class="cursor-pointer absolute inset-y-0 right-0 pl-3 pr-3 flex items-center text-gray-400 hover:text-black focus:outline-blue-500"
